...
@section('title', 'Edit Booking Agreement - ' . $agreement->agreement_number)

@section('content')
<div class="max-w-5xl mx-auto space-y-6" x-data="agreementEditForm()">
    
    <!-- Top Bar -->
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <a href="{{ route('ticketing.agreements.show', $agreement) }}" class="inline-flex items-center gap-1.5 text-xs font-heading font-bold text-dark/60 hover:text-primary transition-colors">
                <i data-lucide="arrow-left" class="w-4 h-4"></i>
                <span>Back to Agreement View</span>
            </a>
            <h1 class="text-xl sm:text-2xl font-heading font-black text-dark tracking-tight mt-1">Edit Booking Agreement {{ $agreement->agreement_number }}</h1>
            <p class="text-xs text-dark/50">Modify custom pricing, flight schedule segments, or contract conditions.</p>
        </div>
    ...
    <form action="{{ route('ticketing.agreements.update', $agreement) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="client_names" value="{{ old('client_names', $agreement->client_names) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="contact_phone" value="{{ old('contact_phone', $agreement->contact_phone) }}"
                           class="w-full px-3.5 py-2.5 rounded-xl bg-gray-50 border border-gray-200 text-dark text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-primary">
                </div>

                <div>
                    <label class="block text-xs font-bold text-dark/70 mb-1">Email Address</label>
                    <input type="email" name="contact_email" value="{{ old('contact_email', $agreement->contact_email) }}"
                           class="w-full px-3.5 py-2.5 rounded-xl bg-gray-50 border border-gray-200 text-dark text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-primary">
                </div>

                <div>
                    <label class="block text-xs font-bold text-dark/70 mb-1">Home / Hotel Address</label>
                    <input type="text" name="home_hotel_address" value="{{ old('home_hotel_address', $agreement->home_hotel_address) }}"
                           class="w-full px-3.5 py-2.5 rounded-xl bg-gray-50 border border-gray-200 text-dark text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-primary">
                </div>
            </div>
        </div>

        <!-- 2. Flight & Carrier Matrix -->
        <div class="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm space-y-5">
            <div class="border-b border-gray-100 pb-3 flex items-center justify-between">
                <div class="flex items-center gap-2">
                        ...
                        <template x-for="(seg, idx) in segments" :key="idx">
                            <tr class="hover:bg-gray-50/70">
                                <td class="p-1.5 border-r border-gray-200">
                                    <input type="text" :name="'flight_segments[' + idx + '][carrier]'" x-model="seg.carrier"
                                           class="w-full px-2 py-1 bg-transparent border-0 font-semibold focus:ring-1 focus:ring-primary rounded">
                                </td>
                                <td class="p-1.5 border-r border-gray-200">
                                    <input type="text" :name="'flight_segments[' + idx + '][flight_number]'" x-model="seg.flight_number"
                                           class="w-20 px-2 py-1 bg-transparent border-0 font-mono font-semibold focus:ring-1 focus:ring-primary rounded">
                                </td>
                                <td class="p-1.5 border-r border-gray-200">
                                    <input type="text" :name="'flight_segments[' + idx + '][flight_class]'" x-model="seg.flight_class"
                                           class="w-16 px-2 py-1 bg-transparent border-0 focus:ring-1 focus:ring-primary rounded">
                                </td>
                                <td class="p-1.5 border-r border-gray-200">
                                    <input type="text" :name="'flight_segments[' + idx + '][day]'" x-model="seg.day"
                                           class="w-16 px-2 py-1 bg-transparent border-0 focus:ring-1 focus:ring-primary rounded">
                                </td>
                                <td class="p-1.5 border-r border-gray-200">
                                    <input type="text" :name="'flight_segments[' + idx + '][month]'" x-model="seg.month"
                                           class="w-16 px-2 py-1 bg-transparent border-0 uppercase font-semibold focus:ring-1 focus:ring-primary rounded">
                                </td>
                                <td class="p-1.5 border-r border-gray-200">
                                    <input type="text" :name="'flight_segments[' + idx + '][from_location]'" x-model="seg.from_location"
                                           class="w-20 px-2 py-1 bg-transparent border-0 font-semibold focus:ring-1 focus:ring-primary rounded">
                                </td>
                                <td class="p-1.5 border-r border-gray-200">
                                    <input type="text" :name="'flight_segments[' + idx + '][to_location]'" x-model="seg.to_location"
                                           class="w-20 px-2 py-1 bg-transparent border-0 font-semibold focus:ring-1 focus:ring-primary rounded">
                                </td>
                                <td class="p-1.5 border-r border-gray-200">
                                    <input type="text" :name="'flight_segments[' + idx + '][departure_time]'" x-model="seg.departure_time"
                                           class="w-20 px-2 py-1 bg-transparent border-0 focus:ring-1 focus:ring-primary rounded">
                                </td>
                                <td class="p-1.5 border-r border-gray-200">
                                    <input type="text" :name="'flight_segments[' + idx + '][arrival_time]'" x-model="seg.arrival_time"
                                           class="w-20 px-2 py-1 bg-transparent border-0 focus:ring-1 focus:ring-primary rounded">
                                </td>
                                <td class="p-1.5 border-r border-gray-200">
                                    <input type="text" :name="'flight_segments[' + idx + '][flight_status]'" x-model="seg.flight_status"
        ...
        <!-- 3. Conditions & Inclusions Toggles -->
        <div class="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm space-y-4">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 text-xs font-semibold">
                <label class="flex items-center gap-2.5 p-3 rounded-xl border border-gray-200 bg-gray-50/50 cursor-pointer hover:bg-gray-100/70">
                    <input type="checkbox" name="has_baggage" value="1" {{ $agreement->has_baggage ? 'checked' : '' }} class="rounded text-primary focus:ring-primary w-4 h-4">
                    <span>With Baggage</span>
                </label>

                <label class="flex items-center gap-2.5 p-3 rounded-xl border border-gray-200 bg-gray-50/50 cursor-pointer hover:bg-gray-100/70">
                    <input type="checkbox" name="is_non_refundable" value="1" {{ $agreement->is_non_refundable ? 'checked' : '' }} class="rounded text-primary focus:ring-primary w-4 h-4">
                    <span>Non Refundable</span>
                </label>

                <label class="flex items-center gap-2.5 p-3 rounded-xl border border-gray-200 bg-gray-50/50 cursor-pointer hover:bg-gray-100/70">
                    <input type="checkbox" name="is_non_rebookable" value="1" {{ $agreement->is_non_rebookable ? 'checked' : '' }} class="rounded text-primary focus:ring-primary w-4 h-4">
                    <span>Non Rebookable</span>
                </label>

                <label class="flex items-center gap-2.5 p-3 rounded-xl border border-gray-200 bg-gray-50/50 cursor-pointer hover:bg-gray-100/70">
                    <input type="checkbox" name="has_meals" value="1" {{ $agreement->has_meals ? 'checked' : '' }} class="rounded text-primary focus:ring-primary w-4 h-4">
                    <span>With Meals</span>
                </label>

                <label class="flex items-center gap-2.5 p-3 rounded-xl border border-gray-200 bg-gray-50/50 cursor-pointer hover:bg-gray-100/70">
                    <input type="checkbox" name="with_rebooking_charge" value="1" {{ $agreement->with_rebooking_charge ? 'checked' : '' }} class="rounded text-primary focus:ring-primary w-4 h-4">
                    <span>With Rebooking Charge</span>
                </label>

                <label class="flex items-center gap-2.5 p-3 rounded-xl border border-gray-200 bg-gray-50/50 cursor-pointer hover:bg-gray-100/70">
                    <input type="checkbox" name="with_airport_transfer" value="1" {{ $agreement->with_airport_transfer ? 'checked' : '' }} class="rounded text-primary focus:ring-primary w-4 h-4">
                    <span>With Airport Transfer</span>
                </label>
            </div>
        </div>

        <!-- 4. Agent Pricing & Quotation Matrix -->
        <div class="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm space-y-5">
            <div class="border-b border-gray-100 pb-3 flex items-center justify-between">
                <div class="flex items-center gap-2">
            ...
            <div class="pt-2">
                ...
                <textarea name="payment_terms" rows="2"
                          class="w-full px-3.5 py-2 rounded-xl bg-gray-50 border border-gray-200 text-dark text-xs focus:outline-none focus:ring-2 focus:ring-primary">{{ old('payment_terms', $agreement->payment_terms) }}</textarea>
            </div>
        </div>
        ...
        <div class="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="agent_name" value="{{ old('agent_name', $agreement->agent_name) }}" required
                           class="w-full px-3.5 py-2.5 rounded-xl bg-gray-50 border border-gray-200 text-dark text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-primary">
                </div>
                <div>
                    <label class="block text-xs font-bold text-dark/70 mb-1">Passenger / Client Name *</label>
                    <input type="text" name="passenger_client_name" value="{{ old('passenger_client_name', $agreement->passenger_client_name) }}" required
                           class="w-full px-3.5 py-2.5 rounded-xl bg-gray-50 border border-gray-200 text-dark text-xs font-semibold focus:outline-none focus:ring-2 focus:ring-primary">
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-between pt-2">
            <a href="{{ route('ticketing.agreements.show', $agreement) }}" class="px-5 py-3 rounded-2xl border border-gray-200 text-dark/70 font-bold text-xs hover:bg-gray-100 transition-colors">
                Cancel
            </a>
            <button type="submit" class="inline-flex items-center gap-2 px-8 py-3.5 rounded-2xl bg-primary text-white font-heading font-extrabold text-xs uppercase tracking-wider hover:bg-navy transition-all shadow-lg shadow-primary/25">
                <i data-lucide="save" class="w-4 h-4"></i>
                <span>Save Agreement Updates</span>
            </button>
        </div>
    </form>
</div>
...
function agreementEditForm() {
    return {
        segments: @json($agreement->flight_segments ?? []),
        pricing: @json($agreement->pricing_items ?? []),
        grandTotal: {{ (float) $agreement->total_amount }},
