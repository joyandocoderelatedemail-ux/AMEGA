...
@section('content')
    <div class="pt-20 bg-primary-dark text-white text-center py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-blue-200/70 text-base max-w-2xl mx-auto mt-3">Discover what sets Amega Travel and Tours Services apart after 24+ years of travel excellence.</p>
        </div>
    </div>
