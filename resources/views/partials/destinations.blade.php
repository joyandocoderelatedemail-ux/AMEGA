<section id="destinations" class="py-20 sm:py-24 bg-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16 animate-on-scroll">
            ...
            <h2 class="font-heading text-4xl sm:text-5xl font-bold text-dark mt-2">Domestic Island Packages</h2>
        ...
        <div class="mb-16">
            <div class="flex items-center gap-3 mb-8 animate-on-scroll">
                ...
                <h3 class="font-heading text-2xl sm:text-3xl font-bold text-dark">Local Destinations</h3>
                <span class="text-xs text-primary font-semibold tracking-widest uppercase px-3 py-1 rounded-full bg-primary/5 border border-primary/20">Philippines</span>
            </div>
                        ...
                        <div class="rounded-2xl overflow-hidden bg-white border border-gray-100 shadow-sm h-full">
                            ...
                            <div class="p-5">
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="font-heading text-xl font-bold text-primary">From {{ $dest->starting_price }}</span>
                                    <a href="{{ route('packages.index') }}?search={{ urlencode($dest->name) }}" class="inline-flex items-center px-5 py-2.5 bg-primary text-white text-xs font-bold rounded-full hover:bg-primary-dark transition-all duration-300 shadow-md">
                                        View Packages
        ...
        <div>
            <div class="flex items-center gap-3 mb-8 animate-on-scroll">
                <div class="w-1 h-8 bg-accent rounded-full"></div>
                <h3 class="font-heading text-2xl sm:text-3xl font-bold text-dark">International Destinations</h3>
                <span class="text-xs text-primary font-semibold tracking-widest uppercase px-3 py-1 rounded-full bg-primary/5 border border-primary/20">Worldwide</span>
            </div>
